...
let formattedReport = document.querySelector('#formatted-report')
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (currentDate.getHours() >= 5 && currentDate.getHours() <= 17) { // dia
        ...
        formattedReport.innerHTML = '*Almoço ' + day + '/' + month + '*<br>'
        ...
        if(currentDate.getHours() >= 0 && currentDate.getHours() <= 4){
            ...
            formattedReport.innerHTML = '*Noite ' + day + '/' + month + '*<br>'
        }else{
            legend.innerText = 'Noite ' + day + '/' + month
            formattedReport.innerHTML = '*Noite ' + day + '/' + month + '*<br>'
        }
...
document.querySelector('.copy-button').addEventListener('click', function() {
    const relatorio = document.getElementById('formatted-report');
    const textoRelatorio = relatorio.innerText || relatorio.textContent;
